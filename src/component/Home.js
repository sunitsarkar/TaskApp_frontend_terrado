...
export default function Home() {
    ...
    const handleSubmit = async (e) => {
        ...
        let res = await dispatch(taskkAdd(formData));
    ...
    const handleEditSubmit = async() => {
        await dispatch(updateTasks({ ...editFormData, id: id }));
        window.location.reload();
    }
                                            ...
                                            <div className="modal-dialog">
                                                <div className="modal-content">
                                                    ...
                                                    <div className="modal-footer">
                                                        <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={() => { editFormData.task = '' }}>Close</button>
                                                        <button type="button" className="btn btn-primary" onClick={(e) => { e.preventDefault(); handleEditSubmit() }}>Save changes</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
